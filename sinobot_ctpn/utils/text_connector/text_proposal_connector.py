...
from sinobot_ctpn.utils.text_connector.other import clip_boxes
from sinobot_ctpn.utils.text_connector.text_proposal_graph_builder import TextProposalGraphBuilder
