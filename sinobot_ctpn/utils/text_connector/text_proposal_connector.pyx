...
from sinobot_ctpn.utils.text_connector import text_proposal_graph_builder


class TextProposalConnector:
    def __init__(self):
        self.graph_builder = text_proposal_graph_builder.TextProposalGraphBuilder()
    ...
    def get_text_lines(self, text_proposals, scores, im_size):
        ...
        text_lines = other.clip_boxes(text_lines, im_size)
